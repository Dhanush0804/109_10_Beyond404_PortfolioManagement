...
-- ==========================================================
-- Rahul Sharma (MEDIUM) 7 BUY / 3 SELL
-- ==========================================================

(1,1,1,'BUY',150000,'2025-08-10 10:30:00'),
(2,1,34,'BUY',120000,'2025-09-14 11:15:00'),
(3,1,13,'BUY',85000,'2025-10-09 09:40:00'),
(4,1,23,'BUY',70000,'2025-11-12 13:10:00'),
(5,1,36,'BUY',95000,'2025-12-18 14:00:00'),
(6,1,25,'BUY',65000,'2026-01-20 10:20:00'),
(7,1,40,'BUY',55000,'2026-02-25 15:00:00'),

(8,1,7,'SELL',40000,'2026-04-15 11:40:00'),
(9,1,18,'SELL',30000,'2026-06-08 10:10:00'),
(10,1,46,'SELL',25000,'2026-07-18 12:20:00'),

-- ==========================================================
-- Priya Nair (LOW) 8 BUY / 2 SELL
-- ==========================================================

(11,2,15,'BUY',80000,'2025-08-18 09:45:00'),
(12,2,37,'BUY',90000,'2025-09-20 11:20:00'),
(13,2,40,'BUY',70000,'2025-10-16 10:10:00'),
(14,2,43,'BUY',85000,'2025-11-14 13:00:00'),
(15,2,24,'BUY',65000,'2025-12-22 12:40:00'),
(16,2,29,'BUY',50000,'2026-01-26 11:00:00'),
(17,2,20,'BUY',60000,'2026-03-12 15:30:00'),
(18,2,4,'BUY',95000,'2026-05-18 10:50:00'),

(19,2,27,'SELL',20000,'2026-06-20 12:15:00'),
(20,2,41,'SELL',18000,'2026-07-22 09:40:00'),

-- ==========================================================
-- Arjun Mehta (HIGH) 6 BUY / 4 SELL
-- ==========================================================

(21,3,2,'BUY',180000,'2025-08-08 10:00:00'),
(22,3,3,'BUY',200000,'2025-09-11 11:10:00'),
(23,3,5,'BUY',160000,'2025-10-15 13:30:00'),
(24,3,6,'BUY',150000,'2025-11-18 10:45:00'),
(25,3,10,'BUY',90000,'2026-01-08 09:30:00'),
(26,3,35,'BUY',80000,'2026-02-16 14:10:00'),

(27,3,21,'SELL',70000,'2026-03-14 10:20:00'),
(28,3,31,'SELL',65000,'2026-04-20 15:10:00'),
(29,3,49,'SELL',45000,'2026-06-10 11:30:00'),
(30,3,26,'SELL',60000,'2026-07-28 13:20:00'),

-- ==========================================================
-- Sneha Reddy (MEDIUM) 8 BUY / 2 SELL
-- ==========================================================

(31,4,8,'BUY',90000,'2025-08-12 10:15:00'),
(32,4,9,'BUY',85000,'2025-09-15 11:45:00'),
(33,4,16,'BUY',80000,'2025-10-24 12:20:00'),
(34,4,22,'BUY',75000,'2025-11-21 09:30:00'),
(35,4,30,'BUY',65000,'2025-12-28 14:40:00'),
(36,4,38,'BUY',70000,'2026-01-24 10:00:00'),
(37,4,42,'BUY',60000,'2026-03-05 11:15:00'),
(38,4,52,'BUY',50000,'2026-05-22 13:00:00'),

(39,4,32,'SELL',25000,'2026-06-28 10:30:00'),
(40,4,47,'SELL',30000,'2026-07-30 15:10:00');