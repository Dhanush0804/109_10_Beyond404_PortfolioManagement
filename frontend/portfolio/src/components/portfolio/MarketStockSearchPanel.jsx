...
export default function MarketStockSearchPanel({ onSelectStock, disabled = false }) {
  ...
  return (
    ...
    >
      <p className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: 'var(--txt-muted)' }}>
        Search New Stock
      </p>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="input w-full pl-9 pr-3 py-2.5 text-sm rounded-xl"
          disabled={disabled}
        />
      </div>
      ...
      {query.trim() ? (
        <div
          className="mt-2 rounded-xl p-2 max-h-40 overflow-y-auto"
